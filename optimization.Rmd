...
<div id="header">
![](optimization/images/urban-institute-logo.png)
...
through but can be a huge benefit to a project in the long term. An 
important lesson to learn when it comes to optimising an R (or any) program 
is knowing when to stop. Be sure to consider what "fast enough" is for a 
project and how much needs to be optimized.   
