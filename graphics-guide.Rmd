...
Exporting charts as a pdf will allow them to be more easily edited. You may need to tweak pdf export options to preserve fonts. For example, in RStudio on OSX, check this option in the export pdf window: `r knitr::include_graphics("graphics-guide/www/images/pdf_export_option.png")`
