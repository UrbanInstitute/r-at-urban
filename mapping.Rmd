...
state <- states %>%
	filter(state_name %in% c("Virginia"))
...
# drop Alaska and hawaii
# this data frame has the latitude and longitude for each capital
state_capitals <- read_csv("mapping/data/state-capitals.csv") %>%
