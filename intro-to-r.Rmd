...
<div id="header">
![](intro-to-r/images/urban-institute-logo.png)
</div>
...
R is one of two premier programming languages for data science and one of the [fastest growing growing programming languages according to Stack Overflow.](https://stackoverflow.blog/2017/10/10/impressive-growth-r/) Created by researchers for researchers (with some help from software engineers), R offers rich, intuitive tools that make it perfect for visualization, public policy analysis, econometrics, geospatial analysis, and statistics. 
